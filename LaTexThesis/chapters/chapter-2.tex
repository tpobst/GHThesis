...
\begin{itemize}
	...
	\item data suggested that pH increases from lower to higher elevation from decreasing BC corresponding with increasing nitrate.% using the descriptive data what do nitrate and sulfate concentrations look like over elevation	
\end{itemize}
...
The differences between the results in \citet{robinson2008ph} and those in \autoref{tab:Step-wise julian date} and \autoref{tab:time vars} imply that water quality is worse when dealing with 90 sites.%discuss comparison with robinson 08, discuss predictions, expand on differences between data sets
...
Water quality trends will continue to get better than trends before 2008 because pollution is better regulated.%maybe add some info about the future of EPA regulations

The accuracy and usefulness of this trend analysis, %is precise
