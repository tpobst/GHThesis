...
In order to ascertain whether the water quality is increasing or decreasing in the GRSM, a temporal trend analysis is necessary on the water quality data.
...
\begin{figure}
	\centering
	  \includegraphics[width=6in]{MissingFigure}
