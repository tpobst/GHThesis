...
%The increasing and decreasing trends within the Bonferroni figures do not correspond to the Julian date trends found in \autoref{ch:TA}.
%are there any unexpected means
