...
The a priori power analysis can be used to calculate a number of sites per elevation band for the stream survey in the GRSM.
...
For the step-wise equations N will be rounded up to 110.
...
So that instead of completing the trend analysis after one year, you could wait four years and only need to collect 28 samples per year.
